    ...
    return (
        <div>
            <div className={styles.accordionContainer}>
                ...
                <div>
                    <p className={styles.accordionAnswer} style={{ opacity: opacity, marginTop: answerPosition, fontSize: textSize }}>For those traveling from further afield, the suggested accommodation for lodging is <a href="https://www.thehotelumd.com/?gad_source=1&gclid=Cj0KCQiAw6yuBhDrARIsACf94RVjU-mijvlHgp_006IaAlk9pH8ul651BmOa724R3zhHxHh4yahJwYIaAr-jEALw_wcB" target='_blank' rel="noreferrer">The Hotel</a>, which is fairly new and well regarded. <a href="https://reservations.travelclick.com/107316?RatePlanId=3056928" target='_blank' rel="noreferrer">This link</a> can be used to book rooms at the UMD discounted rate. Let me to travel support may be available, in which case we can assist with booking a room.</p>
                </div>
            </div>
            <div className={styles.accordionContainer}>
